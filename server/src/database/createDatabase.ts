const databaseTables = {
    ...
    users: "CREATE TABLE IF NOT EXISTS users(id INT NOT NULL AUTO_INCREMENT,email VARCHAR(50) NOT NULL, password VARCHAR(100) NOT NULL, activated BOOLEAN DEFAULT 0, level INT DEFAULT NULL, registered TIMESTAMP DEFAULT now(), ip_address INT(4) unsigned DEFAULT NULL, ref_id VARCHAR(100) NOT NULL, PRIMARY KEY (id))",
